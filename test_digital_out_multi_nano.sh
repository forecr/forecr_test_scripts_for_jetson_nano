...
sudo echo 1 > /sys/class/gpio/gpio509/value
sleep $sleep_time
...
sudo echo 1 > /sys/class/gpio/gpio510/value
sleep $sleep_time
...
sudo echo 508 > /sys/class/gpio/unexport
sudo echo 509 > /sys/class/gpio/unexport
sudo echo 510 > /sys/class/gpio/unexport
